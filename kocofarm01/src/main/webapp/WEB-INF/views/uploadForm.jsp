			...
			function showUploadResult(uploadResultArr){
				...
				$(uploadResultArr).each(function(i, obj){
					...
					if(!obj.image){
						...
						str += "<button type = 'button' data-file=\'"+fileCallPath+"\' data-type='file'  class='deleteBtn'><i class='fa fa-times'></i></button><br>";
						...
						str += "<li><div>";
						str += "<span> "+ obj.fileName +"</span>";
						str += "<button type = 'button' data-file=\'"+fileCallPath+"\' data-type='image' class='deleteBtn'><i class='fa fa-times'></i></button><br>";
