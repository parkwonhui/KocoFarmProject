						...
						<div class="input_draft">
							...
							<table class="draft" border=0px>
								...
								<tr>
									...
									<td><select name="expenceType" value="formId">
									...
									<td><input type="text" id="expenceDt" name="expenceDt"
							...
							<table id="expenceCont" class="draft" border=0px>
								<tr>
									...
									<td><input type="button" class="sum_btn" id="sumBtn"
										value="계산" />
									<td colspan="2"><input type="text" id="sumPrice"
										name="sumPrice"></td>
								</tr>
							</table>
